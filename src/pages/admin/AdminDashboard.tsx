...
const PAGE_KEYS: Array<{ key: string; label: string; fields: Array<{ k: string; label: string; multiline?: boolean }> }> = [
  ...
  },
  {
    ...
    fields: [
      ...
      { k: "title_lead", label: "Title lead" },
      { k: "title_accent", label: "Title accent (italic)" },
      { k: "title_tail", label: "Title tail" },
      { k: "hero_image_url", label: "Hero image URL" },
      { k: "body_1", label: "Body paragraph 1", multiline: true },
      { k: "body_2", label: "Body paragraph 2", multiline: true },
      { k: "body_image_url", label: "Body image URL" },
      { k: "stat_1_value", label: "Stat 1 value" },
      { k: "stat_1_label", label: "Stat 1 label" },
      { k: "stat_2_value", label: "Stat 2 value" },
      { k: "stat_2_label", label: "Stat 2 label" },
      { k: "stat_3_value", label: "Stat 3 value" },
      { k: "stat_3_label", label: "Stat 3 label" },
      { k: "cta_eyebrow", label: "CTA eyebrow" },
